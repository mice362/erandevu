...
public class UpdateUserCommand : IRequest<UpdatedUserResponse>, ISecuredRequest
{
    ...
    public UpdateUserCommand(Guid ıd, string firstName, string lastName, DateOnly dateOfBirth, string nationalIdentity, string phone, string address, string email, string password)
    {
        Id = ıd;
        FirstName = firstName;
        LastName = lastName;
