...
namespace Persistence.Migrations
{
    ...
    [Migration("20241108092451_LogoveLogoAdıIsOrtagı")]
    partial class LogoveLogoAdıIsOrtagı
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dc84555e-9c96-4073-8cf6-8257497cf894"),
                            Address = "Tekirdağ",
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = new byte[] { 95, 216, 6, 193, 16, 197, 6, 156, 151, 162, 203, 211, 182, 196, 226, 150, 77, 85, 134, 36, 85, 163, 122, 140, 232, 113, 4, 12, 151, 144, 197, 96, 62, 188, 251, 194, 198, 210, 254, 191, 113, 107, 177, 52, 254, 205, 71, 112, 99, 58, 223, 154, 10, 200, 4, 27, 169, 3, 155, 43, 17, 186, 31, 126 },
                            PasswordSalt = new byte[] { 237, 142, 102, 86, 55, 215, 117, 209, 105, 113, 132, 67, 20, 43, 112, 43, 211, 111, 88, 134, 194, 24, 64, 87, 81, 125, 1, 60, 65, 192, 4, 22, 198, 116, 197, 137, 191, 61, 191, 216, 196, 99, 93, 58, 99, 32, 40, 54, 74, 119, 243, 65, 230, 114, 230, 234, 242, 2, 53, 179, 209, 159, 182, 19, 205, 93, 195, 40, 51, 14, 226, 246, 129, 58, 31, 17, 170, 60, 7, 129, 216, 237, 60, 233, 168, 135, 70, 146, 40, 116, 135, 201, 210, 23, 93, 191, 141, 33, 121, 172, 130, 229, 111, 31, 24, 92, 61, 57, 71, 180, 96, 4, 120, 6, 189, 251, 228, 232, 211, 67, 152, 152, 83, 98, 216, 229, 246, 185 },
                            Phone = "05279563492"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("93ad0407-4ced-4072-9f2f-4cf8dd50cd69"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("dc84555e-9c96-4073-8cf6-8257497cf894")
                        });
                });
